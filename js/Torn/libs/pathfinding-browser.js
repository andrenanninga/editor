...
},{"./core/Graph":4,"./core/Grid":5,"./core/Heuristic":6,"./core/Node":7,"./core/Util":8,"./finders/AStarFinder":9,"./finders/BestFirstFinder":10,"./finders/BiAStarFinder":11,"./finders/BiBestFirstFinder":12,"./finders/BiBreadthFirstFinder":13,"./finders/BiDijkstraFinder":14,"./finders/BreadthFirstFinder":15,"./finders/DijkstraFinder":16,"./finders/IDAStarFinder":17,"./finders/JumpPointFinder":18,"heap":1}],4:[function(require,module,exports){
var Node = require('./Node');


/**
 * The Graph class, which serves as the encapsulation of the layout of the nodes
 * with artbirary position and neighbors.
 * @constructor
 * @param {Array.<node>} [matrix]
 *     @param {number} node.x - The x coordinate of the node in the graph.
 *     @param {number} node.y - The y coordinate of the node in the graph.
 *     @param {boolean} node.walkable [walkable] - Whether this node is walkable.
 *     @param {array.<node>} node.neighbors - an array of nodes which
 */
function Graph(matrix) {
    ...
    this.nodes = this._buildNodes(this.matrix);
}
...
Graph.prototype._buildNodes = function(matrix) {
    ...
    for(i = 0; i < matrix.length; ++i) {
        ...
        node = this.addNodeAt(element.x, element.y, element.walkable)
...
/**
 * Adds a new node to the graph if the position given isn't
 * already a node.
 * Set the walkablility of the node at the given position
 * @param {number} x - The x coordinate of the node.
 * @param {number} y - The y coordinate of the node.
 * @param {boolean} [walkable] - The walkability of the node.
 * @return {Node} - The node at the given position
 */
Graph.prototype.addNodeAt = function(x, y, walkable) {
    var node = this.getNodeAt(x, y);
    var walkable = (walkable === undefined ? true : walkable);
    ...
    this.setWalkableAt(x, y, walkable);

    return node;
}

/**
 * Sets a one-way connection between the node and the neighbor.
 * @param {Node} [node] - The node to add the neighbor to
 * @param {Node} [neighbor] - The neighbor node
 */
 ...
 * @param {number} x - The x coordinate of the node.
 * @param {number} y - The y coordinate of the node.
 * @return {Node|false} - Returns the node if found otherwise false
 */
...
/**
 * Return the neighbor of a given node
 * @param {Node} node
 */
...
},{"./Node":7}],5:[function(require,module,exports){
var Node = require('./Node');
...
function Node(x, y, walkable) {
    ...
    /**
     * an array of node with which this node is connectd
     * @type array<Node>
     */
    this.neighbors = [];
};
...
Node.prototype.reset = function(node) {
    var remove = ['h', 'g', 'f', 'closed', 'opened'];
...
},{"../core/Heuristic":6,"../core/Util":8,"heap":1}],10:[function(require,module,exports){
...
},{"../core/Heuristic":6,"../core/Util":8,"heap":1}],12:[function(require,module,exports){
...
},{"../core/Util":8}],14:[function(require,module,exports){
var BiAStarFinder = require('./BiAStarFinder');
...
},{"../core/Util":8}],16:[function(require,module,exports){
var AStarFinder = require('./AStarFinder');
...
},{"./AStarFinder":9}],17:[function(require,module,exports){
var Util       = require('../core/Util');
var Heuristic  = require('../core/Heuristic');
...
},{"../core/Heuristic":6,"../core/Node":7,"../core/Util":8}],18:[function(require,module,exports){
/**
...
},{"../core/Heuristic":6,"../core/Util":8,"heap":1}]},{},[3])(3)
});
;